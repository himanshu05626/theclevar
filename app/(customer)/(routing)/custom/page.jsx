          ...
          <AnimatePresence mode="wait">
            ...
            {views.front && !loading && (
              ...
              >
                ...
                <div className="w-full md:w-72 shrink-0 flex flex-row md:grid md:grid-cols-2 gap-4 overflow-x-auto md:overflow-y-auto custom-scrollbar pb-2 md:pb-0 content-start overflow-auto">
